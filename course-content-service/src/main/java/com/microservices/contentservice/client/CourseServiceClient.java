...
@FeignClient(name = "${feign.course-service.name}", url = "${feign.url.course}")
public interface CourseServiceClient {
    ...
    ResponseEntityDto getCourseByInstructorId(@RequestParam("instructorId") String instructorId, @RequestHeader("Authorization") String token);
